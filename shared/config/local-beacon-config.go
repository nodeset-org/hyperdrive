...
func NewLocalBeaconClient() *config.LocalBeaconConfig {
	...
	cfg.Lighthouse.ContainerTag.Default[Network_LocalTest] = cfg.Lighthouse.ContainerTag.Default[config.Network_Holesky]
	cfg.Lodestar.ContainerTag.Default[Network_LocalTest] = cfg.Lodestar.ContainerTag.Default[config.Network_Holesky]
	cfg.Nimbus.ContainerTag.Default[Network_LocalTest] = cfg.Nimbus.ContainerTag.Default[config.Network_Holesky]
	cfg.Prysm.ContainerTag.Default[Network_LocalTest] = cfg.Prysm.ContainerTag.Default[config.Network_Holesky]
	cfg.Teku.ContainerTag.Default[Network_LocalTest] = cfg.Teku.ContainerTag.Default[config.Network_Holesky]
	return cfg
}
