...
require (
	...
	github.com/nodeset-org/hyperdrive-daemon v0.0.0-20240416214158-bb667036a1d9
	github.com/nodeset-org/hyperdrive-stakewise v0.0.0-20240416214506-6219c6b885ed
