...
require (
	...
	github.com/nodeset-org/hyperdrive-constellation v0.0.0-20240809030708-fb3be2bb7ac6
...
require (
	...
	github.com/nodeset-org/nodeset-client-go v0.0.0-20240802192556-ee6117c1993c // indirect
