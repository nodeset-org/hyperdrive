...
func createRandomPrysmStep(wiz *wizard, currentStep int, totalSteps int, goodOptions []*nmc_config.ParameterOption[nmc_config.BeaconNode]) *choiceWizardStep {
...
func createRandomBnStep(wiz *wizard, currentStep int, totalSteps int, goodOptions []*nmc_config.ParameterOption[nmc_config.BeaconNode]) *choiceWizardStep {
