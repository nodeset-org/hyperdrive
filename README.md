...
Early versions were adapted from the [Rocket Pool Smart Node](https://github.com/rocket-pool/smartnode).

As of 2024, Hyperdrive is entirely based on work from NodeSet, Inc and community contributors.

In 2026, this repository was relicensed from AGPLv3 to MIT. The main reason for this change is to allow everyone to use and modify Hyperdrive without any requirement to publicly share their changes. Notably, this is important for NodeSet operators who operate as a business instead of as an individual that may have security concerns with publicizing their changes, since the AGPLv3 license already allowed for individuals to modify for private personal use without sharing.
