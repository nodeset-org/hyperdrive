...
func startImpl(
	...
	composeFiles, err := deployTemplates(systemDir, userDir, hdSettings)
	if err != nil {
	...
	err = startComposeFiles(userDir, hdSettings.ProjectName, infos, composeFiles)
	if err != nil {
